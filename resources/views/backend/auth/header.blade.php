            ...
            <ul class="nav_item_right" style="list-style: none;">
                ...
                @if(Auth::check())
                    ...
                    @if(auth()->user()->isAdmin())
                        <li class="nav_item nav_item_right">
                            <span class="nav_name" style="color: #5ba4fc; font-size: 15px; font-weight: bold; padding: 0.5rem 0.7rem;">{{ auth()->user()->name }} <i class="ri-verified-badge-line"  style="font-size: 18px;"></i></span>
                    ...
                    @else
                        <li class="nav_item nav_item_right">
                            <span class="nav_name" style="color: #5ba4fc; font-size: 15px; font-weight: bold; padding: 0.5rem 0.7rem;">{{ auth()->user()->name }}</span>
                            <a href="{{ route('profile') }}" class="nav_link" style="font-size: 20px;"><i class="ri-user-settings-line"></i></a>
                ...
                @else
                    <li class="nav_item nav_item_right">
                        ...
                        <a href="/register" class="nav_link nav_name">Register</a>
                    </li>
                @endif
